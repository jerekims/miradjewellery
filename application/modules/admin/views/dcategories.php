                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i>
                                   ...
                                   <a class="crumbs" href="<?php echo base_url(). 'admin/dcategories'?>"><?php echo $admin_subtitle?></a>

                                   <!-- <a class="crumbs" href="<?php echo base_url(). 'index.php/admin'?>">Manager Dashboard</a> > 
                                   <a class="crumbs" href="<?php echo base_url(). 'index.php/admin/dcategories'?>"><?php echo $admin_subtitle?></a> -->
                     ...
                     <div class="table-toolbar">
                       ...
                       <!-- <a class="left adminadd" href="<?php echo base_url(). 'index.php/admin/addcategory'?>">Add <?php echo $admin_subtitle?></a> -->
                         ...
                         <ul class="dropdown-menu">
                           <li><a href="<?php echo base_url(). 'admin/allcategories/inactive/pdf'?>">Export to PDF</a></li>
                           <li><a href="<?php echo base_url(). 'admin/allcategories/inactive/excel'?>">Export to Excel</a></li>

                           <!-- <li><a href="<?php echo base_url(). 'index.php/admin/allcategories/inactive/pdf'?>">Export to PDF</a></li>
                           <li><a href="<?php echo base_url(). 'index.php/admin/allcategories/inactive/excel'?>">Export to Excel</a></li> -->
                         </ul>
                       </div>
                     </div>
