      ...
      foreach ($value as $p => $data) {
        for ($i=0; $i <= $key ; $i++) { ?>
          <div class="singleproduct"  style="width:280px;margin-right:12px;margin-bottom:12px;height:450px;float:left;">
            ...
            <div><a href="<?php echo base_url().'index.php/home/addcart/'?><?php echo $data['Product ID']?>"><button id="cart" type="submit" value="<?php ?>" class="btn btn-primary" style="font-size:15px;color:white;background-color:#BFAE9F;">Add To Cart</button></a></div>
          </div>
